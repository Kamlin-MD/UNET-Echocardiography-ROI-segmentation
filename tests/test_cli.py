...
class TestCLI(unittest.TestCase):
    ...
    def test_main_no_args(self):
        ...
        # Capture stdout
        with patch('sys.argv', ['echoroi']), patch('sys.stdout', new_callable=StringIO) as mock_stdout:
                main()
    ...
    def test_train_cli_args_parsing(self):
        ...
        with patch('sys.argv', test_args), patch('echoroi.cli.train_cli') as mock_train:
    ...
    def test_predict_cli_args_parsing(self):
        ...
        with patch('sys.argv', test_args), patch('echoroi.cli.predict_cli') as mock_predict:
    ...
    def test_evaluate_cli_args_parsing(self):
        ...
        with patch('sys.argv', test_args), patch('echoroi.cli.evaluate_cli') as mock_evaluate:
    ...
    def test_benchmark_cli_args_parsing(self):
        ...
        with patch('sys.argv', test_args), patch('echoroi.cli.benchmark_cli') as mock_benchmark:
...
class TestCLIEntryPoints(unittest.TestCase):
    ...
    def test_train_cli_entry(self):
        ...
        with patch('sys.argv', ['echoroi-train'] + test_args), patch('echoroi.cli.main') as mock_main:
            train_cli_entry()
    ...
    def test_predict_cli_entry(self):
        ...
        with patch('sys.argv', ['echoroi-predict'] + test_args), patch('echoroi.cli.main') as mock_main:
            predict_cli_entry()
            mock_main.assert_called_once()
    ...
    def test_evaluate_cli_entry(self):
        ...
        with patch('sys.argv', ['echoroi-evaluate'] + test_args), patch('echoroi.cli.main') as mock_main:
            evaluate_cli_entry()
            mock_main.assert_called_once()
