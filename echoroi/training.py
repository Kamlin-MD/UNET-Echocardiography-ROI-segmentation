...
class UNetTrainer:
    ...
    def create_callbacks(self, model_save_path: str, log_dir: Optional[str] = None) -> List[tf.keras.callbacks.Callback]:
    ...
    def train(self, 
              ...
              results_dir: Optional[str] = None) -> tf.keras.callbacks.History:
